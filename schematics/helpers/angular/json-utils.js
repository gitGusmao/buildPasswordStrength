...
function appendPropertyInAstObject(recorder, node, propertyName, value, indent) {
    return (0, json_utils_1.appendPropertyInAstObject)(recorder, node, propertyName, value, indent);
}
...
function insertPropertyInAstObjectInOrder(recorder, node, propertyName, value, indent) {
    return (0, json_utils_1.insertPropertyInAstObjectInOrder)(recorder, node, propertyName, value, indent);
}
